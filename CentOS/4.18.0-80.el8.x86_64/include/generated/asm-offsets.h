...
#define TASK_addr_limit 5144 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define KERNEL_IBRS_SPEC_CTRL_entry 0 /* offsetof(struct kernel_ibrs_spec_ctrl, entry) */
#define KERNEL_IBRS_SPEC_CTRL_exit 8 /* offsetof(struct kernel_ibrs_spec_ctrl, exit) */
#define KERNEL_IBRS_SPEC_CTRL_hi32 4 /* offsetof(struct kernel_ibrs_spec_ctrl, hi32) */
