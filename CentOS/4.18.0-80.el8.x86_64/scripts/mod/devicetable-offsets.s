...
# GNU C89 (GCC) version 8.2.1 20180905 (Red Hat 8.2.1-3) (x86_64-redhat-linux)
#	compiled by GNU C version 8.2.1 20180905 (Red Hat 8.2.1-3), GMP version 6.1.2, MPFR version 3.1.6-p2, MPC version 1.0.2, isl version none
...
# scripts/mod/devicetable-offsets.c:225: }
	.loc 1 225 1 is_stmt 0 view .LVU173
#NO_APP
	xorl	%eax, %eax	#
	ret	
	.cfi_endproc
...
.LASF12:
	.string	"bool"
.LASF39:
	.ascii	"GNU C89 8.2.1 20180905 (Red Hat 8.2.1-3) -mno-sse -mno-mmx -"
	...
	.ascii	"gn-loops=1 -funit-at-a-time -fno-asynchronous-unwind-ta"
...
.LASF29:
	.string	"jump_label_t"
.LASF41:
	.string	"/builddir/build/BUILD/kernel-4.18.0-80.el8/linux-4.18.0-80.el8.x86_64"
.LASF42:
