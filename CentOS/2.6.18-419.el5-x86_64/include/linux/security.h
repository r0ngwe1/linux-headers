...
extern int security_ops_task_setrlimit(struct security_operations *ops,
...
static inline int security_task_setrlimit (struct task_struct *p,
					   ...
					   struct rlimit *new_rlim)
{
	return security_ops_task_setrlimit(security_ops, p, resource, new_rlim);
}
...
/* linux/netlink.h cannot be included from this file */
int netlink_cap_capable(struct sk_buff *skb, int cap);

static inline int security_netlink_recv(struct sk_buff * skb, int cap)
{
	if (netlink_cap_capable(skb, cap))
		return -EPERM;
