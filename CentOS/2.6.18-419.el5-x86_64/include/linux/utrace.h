...
extern int utrace_freeze_stop(struct task_struct *tsk);
extern void utrace_unfreeze_stop(struct task_struct *tsk);
extern void utrace_finish_stop(void);

#else  /* !CONFIG_UTRACE */

static inline int utrace_freeze_stop(struct task_struct *tsk)
{
	return 0;
}

static inline void utrace_unfreeze_stop(struct task_struct *tsk)
{
}

static inline void utrace_finish_stop(void)
{
}
