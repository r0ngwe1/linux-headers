...
#define NETIF_F_VLAN_MASK	(NETIF_F_VLAN_TSO | NETIF_F_VLAN_CSUM | \
				 NETIF_F_VLAN_HIGHDMA | NETIF_F_VLAN_SG)
...
#define NETIF_F_ONE_FOR_ALL	(NETIF_F_GSO_SOFTWARE | NETIF_F_GSO_ROBUST | \
				 ...
				 NETIF_F_FRAGLIST | NETIF_F_VLAN_MASK)
...
/* Loop over all netdevs which are enslaved by bond
 * RTNL should be held.
 */
#define for_each_netdev_in_bond(bond, slave)			\
	for (slave = dev_base; slave; slave = slave->next)	\
