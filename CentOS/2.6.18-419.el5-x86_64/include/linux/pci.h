...
struct pci_dev {
	...
	unsigned int	msix_nolock:1; /* Supports lockless interrupt mode */
#endif
...
static inline int pci_enable_obff(struct pci_dev *dev, unsigned long type) { return 0; }
...
/**
 * pci_pcie_cap - get the PCIe capability offset
 * @dev: PCI device
 *
 * This function returns saved PCIe capability offset.
 */
